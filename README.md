...
Peter volunteers with the Association for Computer Studies Educators (ACSE, past-president), OTF Curriculum Forum steering committee (chair), Royal Canadian Legion Branch 138 (Secretary-Treasurer), Chapter 22 (Niagara) of ARM (Active Retired Members, executive member), and Niagara BMW Riders Association (Social Convenor). His past volunteer work also includes WordPress Niagara (on the conference committee) and Cyber-Seniors (Tech Mentor).
